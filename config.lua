-- NOTE: this file only exist as type notation for notnix program, for reference check examples/folder

--- @class Config
--- @field pkgs PkgEntry[] List of packages to install; remove packages from this list to uninstall
--- @field flatpaks PkgEntry[] List of Flatpak packages; WARNING: please configure Flathub repository before using this
